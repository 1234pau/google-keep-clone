...
<div class="containerReminder">
  <svg class="reminderBell" viewBox="0 0 24 24">
    <path fill="currentColor" d="M13 7.037h-2V10H8.037v2H11v2.963h2V12h2.963v-2H13z"/>
...
export class ReminderNote extends HTMLElement {
    constructor() {
        super()
...
customElements.define("reminder-note", ReminderNote)